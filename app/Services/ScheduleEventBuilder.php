...
/**
 * Monta o cronograma consolidado multi-fonte (reservas, assembleias, manutenções,
 * obras, férias, SLAs, contas e cobranças), respeitando permissão+módulo de cada
 * fonte e o escopo de condomínio por papel.
 *
 * Extraído de Panel\ScheduleController para ser compartilhado entre o painel
 * (Inertia) e a API do app móvel — o payload é idêntico nos dois.
 */
class ScheduleEventBuilder
{
    ...
    /**
     * Payload completo do cronograma (calendar, events, summary, condominiums,
     * sources e filters) — mesmo shape consumido por Schedule/Index.tsx.
     *
