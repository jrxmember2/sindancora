    ...
    private array $roles = [
        ...
        'admin' => [
            ...
            'permissions' => [
                ...
                'polls:read', 'polls:manage',
                'lost_found:read', 'lost_found:manage',
                'disciplinary:read', 'disciplinary:manage',
                'community_board:read', 'community_board:manage',
                'audit:read',
            ],
        ],
        'sindico' => [
        ...
        'subsindico' => [
            ...
            'permissions' => [
                ...
                'public_links:read', 'public_links:manage',
                'polls:read', 'polls:manage', 'lost_found:read', 'lost_found:manage',
                'disciplinary:read', 'disciplinary:manage', 'community_board:read', 'community_board:manage',
            ],
        ],
        'conselheiro' => [
            ...
            'permissions' => [
                ...
                'public_links:read',
                'polls:read', 'lost_found:read', 'disciplinary:read', 'community_board:read',
            ],
        ],
        'morador' => [
