...
return new class extends Migration
{
    ...
    {
        $permissions = [
            ['module' => 'lost_found', 'action' => 'read', 'name' => 'lost_found:read', 'description' => 'Ver itens de achados e perdidos'],
            ['module' => 'lost_found', 'action' => 'manage', 'name' => 'lost_found:manage', 'description' => 'Cadastrar, resolver e excluir itens de achados e perdidos'],
        ];
        ...
        $rolePermissions = [
            ...
            'subsindico' => ['lost_found:read', 'lost_found:manage'],
            'conselheiro' => ['lost_found:read'],
        ];
    ...
    {
        $permissionIds = DB::table('permissions')->where('module', 'lost_found')->pluck('id')->all();

        DB::table('role_permissions')->whereIn('permission_id', $permissionIds)->delete();
        DB::table('plan_modules')->where('module', 'lost_found')->delete();
        DB::table('permissions')->where('module', 'lost_found')->delete();
    }
};
